  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>Vehicle Photo Upload</Text>
        <Text style={styles.subtitle}>Vehicle ID: {vehicleId}</Text>
        <Text style={styles.placeholder}>
          This screen will allow hosts to upload and manage vehicle photos,
          including exterior, interior, and detail shots with proper categorization.
        </Text>
      </View>
    </SafeAreaView>
  );
